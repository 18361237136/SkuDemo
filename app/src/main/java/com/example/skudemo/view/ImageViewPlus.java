    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(rawBitmap!=null&&mType!=TYPE_NONE){
            ...
            if(mType==TYPE_CIRCLE){
                ...
                canvas.drawCircle(radius-mBorderWidth,radius-mBorderWidth,radius-mBorderWidth,mPaintBorder);
                ...
                float bitmapRadius=mRectRoundRadius-borderRadius>0.0f?mRectRoundRadius-borderRadius:0.0f;
